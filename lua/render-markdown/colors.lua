...
M.colors = {
  ...
  H1Bg       = '@markup.heading.1.markdown.bg',
  H2Bg       = '@markup.heading.2.markdown.bg',
  H3Bg       = '@markup.heading.3.markdown.bg',
  H4Bg       = '@markup.heading.4.markdown.bg',
  H5Bg       = '@markup.heading.5.markdown.bg',
  H6Bg       = '@markup.heading.6.markdown.bg',
  -- General
  Code       = 'ColorColumn',
